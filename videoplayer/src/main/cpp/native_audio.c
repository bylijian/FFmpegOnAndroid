 ...
 * Signature: ()Z
 */
JNIEXPORT jboolean JNICALL Java_com_lijian_videoplayer_tester_NativeAudioTester_nativeStartCapture(JNIEnv *env, jobject thiz)
{
 ...
 * Signature: ()Z
 */
JNIEXPORT jboolean JNICALL Java_com_lijian_videoplayer_tester_NativeAudioTester_nativeStopCapture(JNIEnv *env, jobject thiz)
{
    g_loop_exit = 1;
    return JNI_TRUE;
}
 ...
 * Signature: ()Z
 */
JNIEXPORT jboolean JNICALL Java_com_lijian_videoplayer_tester_NativeAudioTester_nativeStartPlayback(JNIEnv *env, jobject thiz)
{
 ...
 * Signature: ()Z
 */
JNIEXPORT jboolean JNICALL Java_com_lijian_videoplayer_tester_NativeAudioTester_nativeStopPlayback(JNIEnv *env, jobject thiz)
{
    g_loop_exit = 1;
    return JNI_TRUE;
}
